...
{
    // The code in this sample is primarily the same as the code in the ManyTextureCubes sample (07), but with the
    // addition of input to control the camera position and orientation. Windowed fullscreen mode is also
    // demonstrated. Use the mouse and AWSD keys to fly around, and the ESC key to unattach the mouse from the
    // view, and a second time to exit the program.
    ...
    class Program : IDisposable
    {
        ...
        private void ConfigureInput()
        {
            ...
            // Grasshopper uses Reactive Extensions to expose input events as an observable stream. In your own
            // projects, you'll need to make sure the Reactive Extensions NuGet packages are referenced in order
            // to access all the extension methods for observables.
        ...
        private void CreateAndActivateDefaultMaterial()
        {
            ...
            _graphics.TextureResourceManager.Create2DFromFile("fish", "Textures/fish.jpg");
            _graphics.TextureResourceManager.Create2DFromFile("dog", "Textures/dog.jpg");
            _graphics.TextureResourceManager.Create2DFromFile("cat", "Textures/cat.jpg");
            _graphics.TextureResourceManager.Create2DFromFile("snail", "Textures/snail.jpg");
