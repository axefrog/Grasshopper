...
namespace MultiTexturedCube
{
	class Program : IDisposable
	{
		...
		private void CreateAndActivateDefaultMaterial()
		{
			...
			_graphics.TextureResourceManager.Create("grass-top", "Textures/grass-top.png");
			_graphics.TextureResourceManager.Create("grass-side", "Textures/grass-side.png");
			_graphics.TextureResourceManager.Create("dirt", "Textures/dirt.png");

			// Create a texture array containing each of the five textures above
			_graphics.TextureResourceManager.CreateArray("cubefaces",
