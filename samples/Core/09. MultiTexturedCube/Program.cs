...
using MultiTexturedCube.Properties;
...
namespace MultiTexturedCube
{
    class Program : IDisposable
    {
        ...
        private void CreateAndActivateDefaultMaterial()
        {
            ...
            _graphics.TextureResourceManager.Create2DFromFile("grass-top", "Textures/grass-top.png");
            _graphics.TextureResourceManager.Create2DFromFile("grass-side", "Textures/grass-side.png");
            _graphics.TextureResourceManager.Create2DFromFile("dirt", "Textures/dirt.png");

            // Create a texture array containing each of the five textures above
            _graphics.TextureResourceManager.Create2DArray("cubefaces",
                "grass-top", "grass-side", "dirt");
            ...
            material.Textures.Add("cubefaces");
            material.Samplers.Add("crisp");
            material.Activate();
        }
    ...
    struct Vertex
    {
        ...
        /// <summary>
        /// Defines values that we'll use to tell the vertex shader how to map our vertex structure to the shader's
        /// input structure
        /// </summary>
        public static readonly ShaderInputElementSpec[] ShaderInputLayout =
        {
            ...
            new ShaderInputElementSpec(ShaderInputElementFormat.UInt32, ShaderInputElementPurpose.Custom), 
        };
    }
}
