...
namespace Grasshopper.GridWorld
{
	...
	//		{
	//			Quad = Quad.From(
	//				VertexPosColTex.From(0.0f, depth, 1.0f, 0.0f, 0.0f),
	//				VertexPosColTex.From(1.0f, depth, 1.0f, 1.0f, 0.0f),
	//				VertexPosColTex.From(1.0f, depth, 0.0f, 1.0f, 1.0f),
	//				VertexPosColTex.From(0.0f, depth, 0.0f, 0.0f, 1.0f))
	//		};
	//	}
	//}
